    ...
    @foreach($comments as $comment)
        <tr>
            ...
            <td class="td-actions text-right">
                <button type="button" rel="tooltip" title="Edit Comment" onclick="$(this).closest('tr').next('tr').slideToggle()" class="btn btn-primary btn-link btn-sm">
                    <i class="material-icons">edit</i>
                </button>
                <a href="{{route('comment.delete',$comment)}}" rel="tooltip" title="Remove" class="btn btn-danger btn-link btn-sm">
